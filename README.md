...
<img src="./NestJs_API/nest-api/img/config.png" alt="config">
<br>
<h2>Paginations et routes<h2>
<br>
<img src="./NestJs_API/nest-api/img/academy.png" alt="academy">
<br>
<img src="./NestJs_API/nest-api/img/codePostal.png" alt="codePOstal">
<br>
<img src="./NestJs_API/nest-api/img/getById.png" alt="ID">
<br>
<img src="./NestJs_API/nest-api/img/identifier.png" alt="identifier">
<br>
